...
# Run this script to remove the default VPCS in AWS regions after a new account is created. The pre requisite is to turn off the SCPs temporariliy by using the Administrator Access on the management account
